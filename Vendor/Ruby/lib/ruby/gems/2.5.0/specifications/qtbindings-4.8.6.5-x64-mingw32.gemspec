# -*- encoding: utf-8 -*-
# stub: qtbindings 4.8.6.5 x64-mingw32 lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<qtbindings-qt>.freeze, ["~> 4.8.6.0", ">= 4.8.6.4"])
  else
    s.add_dependency(%q<qtbindings-qt>.freeze, ["~> 4.8.6.0", ">= 4.8.6.4"])
  end
end
